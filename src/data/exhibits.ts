...
export const exhibits: Exhibit[] = [
  ...
  // ── 입장하면 정면으로 보이는 중앙 벽 = YouTube 스크린 ──
  {
    ...
    year: '2026',
    description: 'Out on the road. Replace youtubeId in src/data/exhibits.ts to swap the film.',
  },
  ...
  // ── 북쪽 벽 ── 이미지 · 글 · 이미지 · 이미지
  {
    ...
    scale: 1.0,
    year: '2026',
    captionTop: ['2026', 'ROAD 01'],
    captionBottom: ['LONG DISTANCE'],
  },
  {
    id: 'note-01',
    type: 'text',
    ...
    rotation: WALL.north.rot,
    heading: 'ROAD 01 — 04',
    body: ['Built for the long run.', '2024 — 2026'],
    textWidth: 2.6,
  },
  {
    id: 'project-05',
    ...
    scale: 1.05,
    year: '2026',
    captionTop: ['2025', 'PACE 05'],
    captionBottom: ['TEMPO RUN'],
  },
  {
    id: 'project-02',
    type: 'image',
  ...
  },
  {
    ...
    scale: 1.15,
    year: '2026',
    captionTop: ['2025', 'GEAR 06'],
    captionBottom: ['RUNNING APPAREL', 'Field tested'],
  },
  ...
  // ── 동쪽 벽 (계단 구간은 비움) ── 글 · 이미지
  {
    ...
    heading: 'RACE DAY',
    body: ['Where the training pays off.'],
    textWidth: 3.0,
  },
  {
    id: 'project-07',
  ...
  // ── 계단 벽 ── 오르내리며 읽히는 글씨
  {
    ...
    heading: 'UP TO 02F',
    body: ['The climb is part of the run.', 'Keep your pace.'],
    textWidth: 3.4,
  },
  {
    id: 'stair-02',
  ...
  // ── 중앙 전시벽 뒷면 ──
  {
    ...
    heading: 'INDEX / 01F',
    body: ['01   ROAD', '02   TRAINING', '03   RACE DAY', '04   FILM'],
    textWidth: 3.2,
  },
  ...
  // ── 북쪽 벽 ── 이미지 · 글 · 이미지
  {
    ...
    scale: 1.1,
    year: '2026',
    captionTop: ['2026', 'FORM 08'],
    captionBottom: ['STRIDE STUDY'],
  },
  {
    id: 'note-04',
    type: 'text',
    ...
    rotation: WALL.north.rot,
    heading: 'RECOVERY',
    body: ['Rest is part of the training.'],
    textWidth: 3.0,
  },
  {
    id: 'project-09',
  ...
  // ── 서쪽 긴 벽 ── 이미지 · 글 · 이미지 · 이미지
  {
    ...
    scale: 0.95,
    year: '2026',
    captionTop: ['2026', 'SPLIT 10'],
    captionBottom: ['SPLIT TIMES'],
  },
  {
    id: 'statement-02',
    type: 'text',
    ...
    body: [
      ...
      'The distance remembers all of them.',
    ],
    textWidth: 4.4,
  },
  {
  ...
  },
  {
    ...
    scale: 0.85,
    year: '2026',
    captionTop: ['2024', 'ARCHIVE 12'],
    captionBottom: ['SEASON ARCHIVE'],
  },
  ...
  // ── 2F 중앙 전시벽 ──
  {
    ...
    heading: '02F',
    body: ['Slow down here.', 'This floor is the cool-down lap.'],
    textWidth: 4.4,
    align: 'center',
    rule: false,
  },
  ...
  // ── 남쪽 벽 ──
  {
    ...
    rotation: WALL.south.rot,
    heading: 'FINISH',
    body: ['Take the stairs back down.', 'Thanks for going the distance.'],
    textWidth: 3.6,
  },
]
